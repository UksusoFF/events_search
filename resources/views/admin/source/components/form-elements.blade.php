...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('title'), 'has-success': this.fields.title && this.fields.title.valid }">
    <label for="title" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.source.columns.title') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.title" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('title'), 'form-control-success': this.fields.title && this.fields.title.valid}" id="title" name="title" placeholder="{{ trans('admin.source.columns.title') }}">
        <div v-if="errors.has('title')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('title') }}</div>
    </div>
</div>

<div class="form-group row align-items-center" :class="{'has-danger': errors.has('map_items'), 'has-success': this.fields.map_items && this.fields.map_items.valid }">
    <label for="map_items" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.source.columns.map_items') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.map_items" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('map_items'), 'form-control-success': this.fields.map_items && this.fields.map_items.valid}" id="map_id" name="map_id" placeholder="{{ trans('admin.source.columns.map_items') }}">
        <div v-if="errors.has('map_items')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('map_items') }}</div>
    </div>
</div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('map_date_format'), 'has-success': this.fields.map_date_format && this.fields.map_date_format.valid }">
    <label for="map_date_format" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.source.columns.map_date_format') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.map_date_format" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('map_date_format'), 'form-control-success': this.fields.map_date_format && this.fields.map_date_format.valid}" id="map_date_format" name="map_date_format" placeholder="{{ trans('admin.source.columns.map_date_format') }}">
        <div v-if="errors.has('map_date_format')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('map_date_format') }}</div>
    </div>
</div>
