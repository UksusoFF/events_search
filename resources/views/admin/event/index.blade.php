                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'vid'">{{ trans('admin.event.columns.vid') }}</th>
                                    <th is='sortable' :column="'name'">{{ trans('admin.event.columns.name') }}</th>
                                    <th is='sortable' :column="'start_date'">{{ trans('admin.event.columns.start_date') }}</th>
                                    <th is='sortable' :column="'ignored'">{{ trans('admin.event.columns.ignored') }}</th>
